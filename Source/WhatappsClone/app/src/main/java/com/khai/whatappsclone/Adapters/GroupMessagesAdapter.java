...
import com.khai.whatappsclone.databinding.ItemReceiveBinding;
import com.khai.whatappsclone.databinding.ItemReceiveGroupBinding;
import com.khai.whatappsclone.databinding.ItemSentBinding;
import com.khai.whatappsclone.databinding.ItemSentGroupBinding;
...
public class GroupMessagesAdapter extends RecyclerView.Adapter{
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        ...
        ReactionPopup popup = new ReactionPopup(context, config, (pos) -> {
            ...
            FirebaseDatabase.getInstance("https://whatappsclone-335fb-default-rtdb.asia-southeast1.firebasedatabase.app").getReference()
                    .child("public")
        ...
        if(holder.getClass() == SentViewHolder.class){
            ...
            FirebaseDatabase.getInstance("https://whatappsclone-335fb-default-rtdb.asia-southeast1.firebasedatabase.app")
                    .getReference()
                    .child("users")
